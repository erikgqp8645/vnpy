...
class BitfinexGatewayGuo(BaseGateway):
    """
    ...
    def __init__(self, event_engine):
        """Constructor"""
        super(BitfinexGatewayGuo, self).__init__(event_engine, "BITFINEX")
        ...
        [     "tBTCUSD",
          ...
          0.0032,
           7920.5,
            ...
            {
            "reason": "TRADE",
            "order_id": 37373330917,
            "order_id_oppo": 37282252275,
            "liq_stage": null,
            "trade_price": "8313.6",
            "trade_amount": "0.0016"
             }
...
if __name__ == "__main__":
    cont = BitfinexGatewayGuo(event_engine=Event)
